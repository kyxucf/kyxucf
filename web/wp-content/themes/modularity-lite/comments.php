...
<?php if ($comments) : ?>
	<h3 id="comments"><?php comments_number('No Responses', 'One Response', '% Responses' );?> <span class="comments-subscribe"><?php post_comments_feed_link('Subscribe to comments'); ?></span></h3>
